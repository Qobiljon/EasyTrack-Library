...
public final class ETServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage,
      inha.nsl.easytrack.EtService.DefaultResponseMessage> getSubmitNotificationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "submitNotification",
      requestType = inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage.class,
      responseType = inha.nsl.easytrack.EtService.DefaultResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage,
      inha.nsl.easytrack.EtService.DefaultResponseMessage> getSubmitNotificationMethod() {
    io.grpc.MethodDescriptor<inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage, inha.nsl.easytrack.EtService.DefaultResponseMessage> getSubmitNotificationMethod;
    if ((getSubmitNotificationMethod = ETServiceGrpc.getSubmitNotificationMethod) == null) {
      synchronized (ETServiceGrpc.class) {
        if ((getSubmitNotificationMethod = ETServiceGrpc.getSubmitNotificationMethod) == null) {
          ETServiceGrpc.getSubmitNotificationMethod = getSubmitNotificationMethod = 
              io.grpc.MethodDescriptor.<inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage, inha.nsl.easytrack.EtService.DefaultResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ETService", "submitNotification"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  inha.nsl.easytrack.EtService.DefaultResponseMessage.getDefaultInstance()))
                  .build();
          }
     ...
     return getSubmitNotificationMethod;
  }
  ...
  public static abstract class ETServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void submitNotification(inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage request,
        io.grpc.stub.StreamObserver<inha.nsl.easytrack.EtService.DefaultResponseMessage> responseObserver) {
      asyncUnimplementedUnaryCall(getSubmitNotificationMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getSubmitNotificationMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage,
                inha.nsl.easytrack.EtService.DefaultResponseMessage>(
                  this, METHODID_SUBMIT_NOTIFICATION)))
          .addMethod(
  ...
  public static final class ETServiceStub extends io.grpc.stub.AbstractStub<ETServiceStub> {
    ...
    public void submitNotification(inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage request,
        io.grpc.stub.StreamObserver<inha.nsl.easytrack.EtService.DefaultResponseMessage> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getSubmitNotificationMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class ETServiceBlockingStub extends io.grpc.stub.AbstractStub<ETServiceBlockingStub> {
    ...
    /**
     */
    public inha.nsl.easytrack.EtService.DefaultResponseMessage submitNotification(inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage request) {
      return blockingUnaryCall(
          getChannel(), getSubmitNotificationMethod(), getCallOptions(), request);
    }
  ...
  public static final class ETServiceFutureStub extends io.grpc.stub.AbstractStub<ETServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<inha.nsl.easytrack.EtService.DefaultResponseMessage> submitNotification(
        inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage request) {
      return futureUnaryCall(
          getChannel().newCall(getSubmitNotificationMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_SUBMIT_NOTIFICATION = 10;
  private static final int METHODID_RETRIEVE_PARTICIPANTS = 11;
  private static final int METHODID_RETRIEVE_PARTICIPANT_STATISTICS = 12;
  private static final int METHODID_RETRIEVE100DATA_RECORDS = 13;
  private static final int METHODID_RETRIEVE_FILTERED_DATA_RECORDS = 14;
  private static final int METHODID_RETRIEVE_UNREAD_DIRECT_MESSAGES = 15;
  private static final int METHODID_RETRIEVE_UNREAD_NOTIFICATIONS = 16;
  private static final int METHODID_BIND_DATA_SOURCE = 17;
  private static final int METHODID_RETRIEVE_ALL_DATA_SOURCES = 18;
      ...
      switch (methodId) {
        ...
        case METHODID_SUBMIT_DIRECT_MESSAGE:
          serviceImpl.submitDirectMessage((inha.nsl.easytrack.EtService.SubmitDirectMessageRequestMessage) request,
              (io.grpc.stub.StreamObserver<inha.nsl.easytrack.EtService.DefaultResponseMessage>) responseObserver);
          break;
        case METHODID_SUBMIT_NOTIFICATION:
          serviceImpl.submitNotification((inha.nsl.easytrack.EtService.SubmitNotificationRequestMessage) request,
              (io.grpc.stub.StreamObserver<inha.nsl.easytrack.EtService.DefaultResponseMessage>) responseObserver);
          break;
      ...
      synchronized (ETServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSubmitNotificationMethod())
